export const listHama = [
  {
    ...
    howToControl: [
      "Dengan pelestarian musuh alami yaitu laba-laba, kepik mirid, kumbang karabid, kumbang coccinellid dan capung.",
      ...
      "Penggunaan insektisida dilakukan dengan cara keringkan pertanaman sebelum  mengaplikasikannya pada saat air embun tidak ada di jam 08.00-11.00 dengan dosis yang tepat yakni Imidacloprid, fipronil, theametoxam, buprofezin beserta air pelarut 350-500 liter air/ha.",
      "Usahakan sedikit mungkin penggunaan pestisida yang mengganggu habitat musuh alami, apabila terpaksa menggunakan pestisida harus memperhatikan jenis yang tepat sesuai OPT sasaran, dosis, konsentrasi, cara dan waktu aplikasi."
    ]
  },
  {
    ...
    howToControl: [
      ...
      "menyemprotkan insektisida berbahan aktif seperti bupofrezin, BPMC, imidakloprid, karbofuran, MIPC dan Tiametoksam. Penggunaan insektisida sistemik butiran (carbofuran) lebih efektif mencegah penularan tungro.",
      "Insektisida yg dianjurkan berbahan aktif seperti BPMC (Bassa, Kiltop), Budprofezin (Applaud), Imidaklroprid (Confidor), Carbofurant, MIPC  (Mipcin, Dharmacin), tiametoksam(Actara)."
    ]
  },
  {
    ...
    howToControl: [
      "Cara membasmi hama ini adalah menyemprotkan cairan ekstrak dan tembakau",
      "Memanfaatkan predator alami seperti kepik atau belalang yang dapat membantu mengendalikan populasi walang sangit dengan cara memakan mereka.",
      "Menggunakan larutan sabun dengan cara campurkan air dengan sedikit cairan pencuci piring, lalu semprotkan ke tanaman yang terkena hama walang sangit. Larutan sabun ini dapat membantu mengendalikan populasi hama tanpa merusak tanaman"
    ]
  },
  {
    ...
    howToControl: [
      {
        title: "Pengendalian dengan Pola Tanam",
        items: [
          ...
          "Pengaturan waktu tanam yaitu berdasarkan penerbangan ngengat atau populasi larva di tunggul padi yakni 15 hari sesudah puncak penerbangan ngengat generasi pertama atau 15 hari sesudah puncak penerbangan ngengat di generasi berikutnya."
        ]
      },
      {
        title: "Pengendalian Secara Mekanik dan Fisik",
        items: [
          "Mekanik dengan cara mengumpulkan kelompok telur di persemaian dan di pertanaman.",
          "Fisik dengan cara penyabitan tanaman serendah mungkin dan penggenangan air setinggi 10 cm agar jerami atau pangkal jerami cepat membusuk sehingga larva mati."
        ]
      },
      {
        title: "Pengendalian Hayati",
        items: [
          "Pemanfaatan musuh alami parasitoid Trichogramma japonicum dengan dosis 20 pias/ha. (1 pias = 2000-2500 telur terparasit) dilakukan sejak awal pertanaman."
        ]
      },
      {
        title: "Pengendalian Kimiawi",
        items: [
          "Menggunakan insektisida berbahan aktif seperti Carbofurant (Furadan), Carbosulfan (Marshal), Dimehipo (Dipho), Bisultap (Spontan),  Amitraz (Mitac), Fipronil (Regent)."
        ]
      }
    ]
  },
  {
    ...
    howToControl: [
      "Kepinding tanah bertelur pada pelepah daun di ketinggian 10 cm dari permukaan lumpur.  Oleh karena itu pengendalian dapat dilakukan dengan menggenang lahan setinggi 15 cm selama semalam.",
      "Dapat menggunakan insektisida yang berbahan aktif seperti BPMC, Fipronil, Metolcarb, MIPC, atau Propoksur.",
      "Memasang lampu petromak yang digantungkan diatas bejana yang telah diisi minyak tanah (kerosin), sehingga kepinding yang jatuh dari lampu dapat ditampung dalam wadah.",
      "Dapat diaplikasikan dengan Beauveria bassiana atau Metarhizium anisopliae"
    ]
  }
]